                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Software Contest Registration</li>
                ...
                <form method="post" >
                    ...
                    <div class="row">
                        ...
                        <div class="coach-info">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control empty iconified" name="CoachName" id="name" required="required" placeholder="&#xf183;   Name">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="email" class="form-control empty iconified" name="CoachEmail" id="email" required="required" placeholder="&#xf0e0;   E-mail">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="tel" class="form-control empty iconified" name="CoachMobile" id="mobile" required="required" placeholder="&#xf10b;   Mobile No.">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="file" class="form-control empty" name="CoachPhoto" id="photo" required="required">
                                </div>
                            </div>
                        </div>
